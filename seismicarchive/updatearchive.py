...
def analysis_window(config):
    ...
    Arguments : config is a seismicarchive.models.Config instance
    """
...
def create_availability_postfile(filename, nslc_list,
    ...
    Arguments:
        ...
        nslc_list : `list of seismicarchive.models.NSLC`
...
def update_availability(source, nslc_list, availability_file,
    ...
    """
    Method which creates or updates a seismicarchive.models.SourceAvailability
...
def update(progress_recorder=FakeProgress(), starttime=None, endtime=None):
    ...
    # 4) Execute Stack
    stack.execute_stack(config,progress_recorder)
