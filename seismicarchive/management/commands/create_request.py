...
from seismicarchive.models import Configuration, Source, Gap, NSLC, \
    Network, Station, Location, Channel
from seismicarchive import updatearchive, stack, stats
import logging
import os
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        update = updatearchive.update_source_infos(
