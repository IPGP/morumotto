...
from morumotto import cronjobs
...
class ConfigurationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Setup', {
           'fields': ['name', 'initialisation', 'debug_mode']
        }),
        ('Output options', {
...
def set_to_new(modeladmin, request, queryset):
    queryset.update(status="new")
set_to_new.short_description = "Set selected requests status to 'new'"


def put_on_hold(modeladmin, request, queryset):
    queryset.update(status="on_hold")
put_on_hold.short_description = "Set selected requests status to 'on_hold'"
...
class RequestAdmin(admin.ModelAdmin):
    ...
    actions = [set_to_new, put_on_hold, cancel_request]
