# -*- coding: utf-8 -*-
"""
Django settings for siqaco project.
...
INSTALLED_APPS = [
    ...
    'seismicarchive.apps.SeismicarchiveConfig', #Cette ligne permet de dire à Django de créer les tables correspondant aux classes qui se trouvent dans sicaqo_project/seismicarchive/models.py
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'siqaco.context_processors.my_login_form'
            ],
        },
    },
]

WSGI_APPLICATION = 'siqaco.wsgi.application'
...
ADMIN_REORDER = (
    ...
    {'app': 'seismicarchive', 'label': 'update', 'models': (
        'seismicarchive.Configuration',
        'seismicarchive.NSLC',
        'seismicarchive.Network',
        'seismicarchive.Station',
        'seismicarchive.Location',
        'seismicarchive.Channel',
        'seismicarchive.Source',
        'seismicarchive.Gap',
        'seismicarchive.DataFile',
        'seismicarchive.Postfile',
        'seismicarchive.Request',
        'seismicarchive.SourceAvailability',
        'seismicarchive.SourceAvailabilityStat',
        'seismicarchive.SourceOnlineStat')},
